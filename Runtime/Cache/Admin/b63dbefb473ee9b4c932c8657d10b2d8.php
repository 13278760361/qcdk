...
<div class="fangcms_box">
    <form method="post">
        <div class="form-group">
            ...
            <div class="field">
                <input type="text" class="input" id="prize_name" name="prize_name" size="50" placeholder="奖品名称" />
            </div>
        </div>
        <div class="form-group">
            <div class="label">
            ...
            <div class="field" id="scene_id">
                <input type="text" class="input" disabled="disabled" name="" value="<?php echo ($info["scene_name"]); ?>"/>
                <input type="text" name="scene_id" hidden="hidden" value="<?php echo ($info["id"]); ?>"/>
            </div>
        </div>
        <div class="form-group">
            <div class="label">
            ...
            <div class="field" id="type_id">
                <select name="type" class="input" id="">
                    ...
                    <?php if(is_array($type)): $i = 0; $__LIST__ = $type;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><option value="<?php echo ($vo); ?>" ><?php echo ($vo); ?></option><?php endforeach; endif; else: echo "" ;endif; ?>
                </select>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="field">
                ...
                <input type="hidden" id="site_prize" name="site_prize" value="<?php echo C('DEFAULT_IMG');?>">
            </div>
        </div>
        <img src="<?php echo C('DEFAULT_IMG');?>" width="100" height="100" class="img-border radius-small" id="prize_img" />
        <div class="form-group">
            <div class="label">
                <label >
            ...
            <div class="field">
                <input type="text" class="input" id="money" name="money" size="50" placeholder="奖品金额" />
            </div>
        </div>
        <div class="form-group">
            <div class="label">
            ...
            <div class="field">
                <input type="text" class="input" id="num" name="num" size="50" placeholder="奖品数量" />
            </div>
        </div>
        <div class="form-group">
            <div class="label">
            ...
            <div class="field">
                <input type="text" class="input" id="prob" name="prob" size="50" placeholder="奖品概率" />
            </div>
        </div>
...
$(function () {
    ...
    function add(){
       ...
       // var scene_id = $("#sene_id select");
        var scene_id = $("input[name='scene_id']");
